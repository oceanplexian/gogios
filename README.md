...
Nagios 4.x works. It's battle-tested. Gogios keeps the config format and full ecosystem compatibility (your existing configs, check plugins, and Thruk dashboards all work) while replacing the internals with a modern, single-binary Go implementation.
